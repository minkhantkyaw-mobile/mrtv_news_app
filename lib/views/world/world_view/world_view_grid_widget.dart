...
import 'package:mrtv_new_app_sl/views/world/world_view/world_dialog_widget.dart';

class WorldViewGridWidget extends StatelessWidget {
  final Records video;
  const WorldViewGridWidget(this.video, {super.key});
    ...
    return GestureDetector(
      onTap: () {
        Get.dialog(
          ...
          Get.delete<WorldDialogController>();
        });
      },
      child: Card(
        color:
