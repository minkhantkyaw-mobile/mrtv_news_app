...
import 'package:mrtv_new_app_sl/viewModels/world/world_viewmodel/world_view_model.dart';
import 'package:mrtv_new_app_sl/views/world/world_search/world_search_screen.dart';
import 'package:mrtv_new_app_sl/views/world/world_view/world_view_grid_widget.dart';
import 'package:pull_to_refresh/pull_to_refresh.dart';

class WorldNewScreen extends StatelessWidget {
  const WorldNewScreen({super.key});

  @override
  Widget build(BuildContext context) {
    final videoVM = Get.put(WorldViewModel(DioHttpService()));
    return GetBuilder<WorldViewModel>(
      builder: (videoVM) {
